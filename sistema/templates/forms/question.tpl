		...
		<form id="frmGral" action="#" class="form-horizontal form-bordered form-label-stripped">
		  ...
		  <div class="form-body">
			  ...
			  <div class="form-group">
				...
				<div class="form-group" id="div_rango"   {if $info.tiporespuesta ne "punto"} style="display:none" {/if}>
						<label class="control-label col-md-3"><span class="reqIcon">*</span> Rango:</label>
					<div class="col-md-9">
							DE:<input type="text" name="de" value="{$de}" style="width:50px"  class="form-control"> A:<input type="text" name="a" value="{$a}" style="width:50px"  class="form-control">
					</div>	
				</div>
				
				 
				<div class="form-group" id="div_par" {if $info.tiporespuesta ne "opcional"} style="display:none" {/if}>
